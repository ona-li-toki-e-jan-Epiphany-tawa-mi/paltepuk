...
If I choose to start using this language again, I'll expand on the vocabulary
and come up with some better rules for the noun/adjective -> verb suffixation.
But, for now, you can consider this document the final form of !χραα.
...
- **κομπορ**     - computer.
- **κομποριτνι** - this computer.
- **κομποριρχγ** - that computer.

Adding the interrogrative **-ιζεζ** to a noun means "which X," i.e.:

- **κομποριζεζ** - which computer (in a question.)
...
!χραα is somewhat oligosynthetic, but the exact mechanisms behind word building
are not 100% consistent because I made them they by feel, rather than properly
...
- **!κομπμικεζ** - (n.) the Internet. (adj.) relating to the internet.
...
- **ερτ** - (n.) symbol, letter, glyph.
- **ερτδγμ** - (n.) book, text, article. (adj.) legible.
- **ερτδγμεδ** -  (v.i., v.t.) to read.
- **ερτμικτι** - (n.) dictionary.
- **ερττεμ** - (v.i, v.t.) to write.
- **ερττεμτγκ** - (n.) writing, the act of writing. (adj.) written.
- **ερττεμτγκορ** - (n.) writing tool, printer, pen, pencil.
- **ερττι** - (n.) word. (adj.) wordy.
- **ερττιμικτι** - (n.) sentence.
...
- **κομπ** - (n.) computation, algorithm, execution of a program/algorithm. (adj.) algorithmic, relating to computation.
- **κομπλιβ** - (n.) free and open source software. (adj.) free and open source, relating to free and open source software.
- **κομπμικεζ** - (n.) computer network. (adj.) online, connected to a network.
- **κομπορ** - (n.) computer. (adj.) relating to computers.
- **κομπτγλ** - (v.i., v.t.) to compute, to execute.
- **κομπτι** - (n.) program. (adj.) relating to programs, programmed.
- **κομπτιτεπορ** - (n.) programmer. (adj.) relating to programmers.
...
- **ξεζτικομπ** - (n.) programming language.
...
- **ρετ** - (pa.) delemits relative clauses. [see [#relative-clauses](#relative-clauses))
...
- **τξγδγμτι** - (n.) flag.
- **τξγερττι** - (n.) name. (adj.) named, having a name.
- **τξγερττιτελ** - (v.t.) to name. (v.t. with object denoted by **ορ'**) to call a name.
